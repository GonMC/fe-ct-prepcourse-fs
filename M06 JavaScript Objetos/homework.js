...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   if (objetoProducto.hasOwnProperty('precio') && objetoProducto.hasOwnProperty('porcentajeDeDescuento')) {
      // Agrega la propiedad "calcularPrecioDescuento" como una función al objetoProducto
   ...
   // Retorna el objetoProducto con o sin la propiedad "calcularPrecioDescuento" agregada
